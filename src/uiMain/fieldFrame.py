...
class FieldFrame(tk.Frame):
    ...
    def __init__(self, parent, tituloCriterios, criterios, tituloValores, valores=None, habilitado=None):
        ...
        label_criterios = tk.Label(self, text=tituloCriterios, font=("Arial", 12, "bold"), bg="lightgray", fg="#4B0082")
        label_valores = tk.Label(self, text=tituloValores, font=("Arial", 12, "bold"), bg="lightgray", fg="#4B0082")
